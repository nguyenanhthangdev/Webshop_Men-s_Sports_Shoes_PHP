    ...
    <li>
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td class="text-left">(size: <?php echo $product['size']; ?>)</td>
          
          <td class="text-right">x <?php echo $product['quantity']; ?></td>
          <td class="text-right"><?php echo $product['total']; ?></td>
          <td class="text-center"><button type="button" onclick="cart.remove(<?php echo $product['product_id']; ?>  , <?php echo $product['size']; ?>);" title="Gỡ bỏ" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></button></td>
        </tr>
        <?php } ?>
      </table>
    </li>
