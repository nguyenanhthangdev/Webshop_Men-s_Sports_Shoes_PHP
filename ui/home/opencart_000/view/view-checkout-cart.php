...
<!-- ***********************************Thêm cột giảm giá************************************* -->
                <?php if((int)$product['sale']!=0) { ?>
                  <td class="text-left"><?php echo $product['sale'] . "%"; ?></td>
                <?php } ?>
                <?php if((int)$product['sale']==0) { ?>
                  <td class="text-left"><?php echo "Không" ?></td>
                <?php } ?>
<!-- ***************************************************************************************** -->
                ...
                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <button type="button" data-toggle="tooltip" title="Xóa Bỏ" class="btn btn-danger" onclick="cart.remove('<?php echo $product['product_id']; ?>','<?php echo $product['size']; ?>');"><i class="fa fa-times-circle"></i></button></span></div>
                </td>
<!-- ************************Điều chỉnh lại giá tiền sau khi giảm giá***************************** -->
...
<!-- ********************************************************************************************* -->
            ...
            <tfoot>
		     <tr>
				...
				<td colspan="7" class="text-right"><strong>Tổng giá trị đơn hàng:</strong></td>
