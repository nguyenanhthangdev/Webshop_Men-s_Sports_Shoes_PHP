...
.login form .input-group span i , #eye1{
  font-size: 1.5em;
  color: white;
}
/*===== Tạo con mắt ở phần password =====*/
.matKhau{
  position: relative;
  z-index: 1;
}
...
<div class="login">
  <div class="heading">
	...
	<?php } $_SESSION["ERROR_TEXT"] = null; ?>
      ...
      <div class="input-group input-group-lg matKhau">
        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
        <input name="password" id="pwd" value="<?php echo $_SESSION['FAILED_PASSWORD'];?>" class="form-control" placeholder="Password" type="password">
        
        <!-- Tạo con mắt -->
        <i id="eye1" onclick="chuyenDoiMat1('eye1')" class="fa fa-eye"></i>
